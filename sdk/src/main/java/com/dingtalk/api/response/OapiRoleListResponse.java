...
public class OapiRoleListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7398943777478297187L;
	...
	public static class OpenRole extends TaobaoObject {
		private static final long serialVersionUID = 4829718956792498732L;
		/**
		 * 角色id
		 */
		@ApiField("id")
	...
	public static class OpenRoleGroup extends TaobaoObject {
		private static final long serialVersionUID = 7693292572168829279L;
		/**
		 * 角色组id
		 */
		@ApiField("groupId")
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 1726442627943966858L;
		/**
		 * hasMore
		 */
		@ApiField("hasMore")
