 ...
 */
public class OrgRemove2DingPushDataConverter implements Callback2DingPushDataConverter {
    @Autowired
    ...
    public List<OpenSyncBizDataDO> convert(CorpCallbackQueueDO callbackDO) {
        return callbackBizDataService.convertCorpCallback(callbackDO, OpenSyncBizSyncAction.Tag.ORG_REMOVE);
    }
}
