...
public class CorpHrmEmployeeGetdismissionlistResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2749826217344217454L;
	...
	public static class HrmApiDismissionModel extends TaobaoObject {
		private static final long serialVersionUID = 6384192465634722868L;
		/**
		 * 入职时间
		 */
	...
	public static class HrmApiPage extends TaobaoObject {
		private static final long serialVersionUID = 4276338991869428263L;
		/**
		 * 当前页
		 */
		@ApiField("current")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 8715893826317547455L;
		/**
		 * 错误码
		 */
