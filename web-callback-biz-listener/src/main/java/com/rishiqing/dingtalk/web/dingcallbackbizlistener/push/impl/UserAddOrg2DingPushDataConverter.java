 ...
 */
public class UserAddOrg2DingPushDataConverter implements Callback2DingPushDataConverter {
    @Autowired
    ...
    public List<OpenSyncBizDataDO> convert(CorpCallbackQueueDO callbackDO) {
        return callbackBizDataService.convertStaffCallback(callbackDO, OpenSyncBizSyncAction.Tag.USER_ADD_ORG);
    }
}
