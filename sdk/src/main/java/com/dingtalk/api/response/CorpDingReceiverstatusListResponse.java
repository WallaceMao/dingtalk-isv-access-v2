...
public class CorpDingReceiverstatusListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7657948584571587455L;
	...
	public static class DingReceiverStatusResult extends TaobaoObject {
		private static final long serialVersionUID = 3269629416299841836L;
		/**
		 * 确认状态。0-未确认；1-已确认；
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 6758847497679777476L;
		/**
		 * 错误码
		 */
