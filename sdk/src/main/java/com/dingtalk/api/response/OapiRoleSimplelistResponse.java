...
public class OapiRoleSimplelistResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8261178616736525798L;
	...
	public static class OpenEmpSimple extends TaobaoObject {
		private static final long serialVersionUID = 7122744894326799386L;
		/**
		 * 员工姓名
		 */
		@ApiField("name")
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 3449841198195454637L;
		/**
		 * 后面是否还有数据
		 */
		@ApiField("hasMore")
