...
public class OapiMessageCorpconversationAsyncsendV2Request extends BaseTaobaoRequest<OapiMessageCorpconversationAsyncsendV2Response> {
	...
	* 接收者的用户userid列表
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 4386492181877618229L;
		/**
		 * 文本消息
		 */
		@ApiField("content")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 4581275728169334813L;
		/**
		 * 图片消息
		 */
		@ApiField("media_id")
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 6159138536625885155L;
		/**
		 * messageUrl
		 */
		@ApiField("messageUrl")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 6171459338554471931L;
		/**
		 * media_id
		 */
		@ApiField("media_id")
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 2193326249593123676L;
		/**
		 * duration
		 */
		@ApiField("duration")
	...
	public static class Rich extends TaobaoObject {
		private static final long serialVersionUID = 1337713757515428694L;
		/**
		 * num
		 */
		@ApiField("num")
	...
	public static class Form extends TaobaoObject {
		private static final long serialVersionUID = 6616758933964966332L;
		/**
		 * key
		 */
		@ApiField("key")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 4664136426241113568L;
		/**
		 * author
		 */
		@ApiField("author")
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 6821587622742955728L;
		/**
		 * bgcolor
		 */
		@ApiField("bgcolor")
	...
	public static class OA extends TaobaoObject {
		private static final long serialVersionUID = 2816655763726415996L;
		/**
		 * body
		 */
		@ApiField("body")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 3666289381218384118L;
		/**
		 * text
		 */
		@ApiField("text")
	...
	public static class BtnJsonList extends TaobaoObject {
		private static final long serialVersionUID = 1635429349419281186L;
		/**
		 * action_url
		 */
		@ApiField("action_url")
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 5316183495643347931L;
		/**
		 * btn_json_list
		 */
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 6657156462444529922L;
		/**
		 * action_card
		 */
