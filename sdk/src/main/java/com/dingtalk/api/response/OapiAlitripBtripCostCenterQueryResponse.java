...
public class OapiAlitripBtripCostCenterQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6815811982794976116L;
	...
	public static class OpenOrgEntityDo extends TaobaoObject {
		private static final long serialVersionUID = 6571516329473317243L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenCostCenterQueryRs extends TaobaoObject {
		private static final long serialVersionUID = 5146942654514889181L;
		/**
		 * 绑定支付宝账号
		 */
		@ApiField("alipay_no")
