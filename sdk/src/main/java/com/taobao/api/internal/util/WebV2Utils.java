...
public abstract class WebV2Utils {
	 ...
	 * @return 响应字符串
	 */
	public static HttpResponseData doGet(String url, Map<String, String> params) throws IOException {
	 ...
	 * @return 响应字符串
	 */
	public static HttpResponseData doGet(String url, Map<String, String> params, String charset) throws IOException {
		HttpURLConnection conn = null;
		String rsp = null;
		HttpResponseData data = new HttpResponseData();
		try {
