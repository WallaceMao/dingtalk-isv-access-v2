...
public class OapiReportListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3567455154479672414L;
	...
	public static class JsonObject extends TaobaoObject {
		private static final long serialVersionUID = 7723656662955765899L;
		/**
		 * 模板内容
		 */
		@ApiField("key")
	...
	public static class ReportOapiVo extends TaobaoObject {
		private static final long serialVersionUID = 3675627626133133877L;
		/**
		 * 日志内容
		 */
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 6391688225839617677L;
		/**
		 * 日志列表
		 */
