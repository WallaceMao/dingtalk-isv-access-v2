...
public class OapiAttendanceGetcolumnvalResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4418239169323418521L;
	...
	public static class ColumnDayAndVal extends TaobaoObject {
		private static final long serialVersionUID = 8348621917729148191L;
		/**
		 * 时间
		 */
		@ApiField("date")
	...
	public static class ColumnForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 1738176149148579423L;
		/**
		 * 列id
		 */
		@ApiField("id")
	...
	public static class ColumnValForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 4323674597449626241L;
		/**
		 * 列值数据
		 */
	...
	public static class ColumnValListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 4176449855797471574L;
		/**
		 * 列信息与列值数据
		 */
		@ApiListField("column_vals")
