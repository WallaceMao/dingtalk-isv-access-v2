...
public class OapiAttendanceGetupdatedataResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7713633341826466992L;
	...
	public static class AtAttendanceResultForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 4433857126756642857L;
		/**
		 * 打卡类型 上班还是下班
		 */
		@ApiField("check_type")
	...
	public static class AtApproveForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 2259617336346299425L;
		/**
		 * 审批单开始时间
		 */
		@ApiField("begin_time")
	...
	public static class AtAttendanceRecordForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 2827526259356425147L;
		/**
		 * 基本定位精度
		 */
	...
	public static class AtRestTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 8671338493655322853L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassSettingInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 5359679934431142688L;
		/**
		 * restTimeVOList
		 */
	...
	public static class AtCheckInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 2695691849515677676L;
		/**
		 * 审批单列表
		 */
