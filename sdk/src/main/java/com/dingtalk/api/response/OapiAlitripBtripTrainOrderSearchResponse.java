...
public class OapiAlitripBtripTrainOrderSearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8723342534865369721L;
	...
	public static class OpenInvoiceDo extends TaobaoObject {
		private static final long serialVersionUID = 8184571794329465648L;
		/**
		 * 商旅发票id
		 */
		@ApiField("id")
	...
	public static class OpenCostCenterDo extends TaobaoObject {
		private static final long serialVersionUID = 4125725131315924485L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenPriceInfo extends TaobaoObject {
		private static final long serialVersionUID = 6387854268619566842L;
		/**
		 * 消费类型
		 */
		@ApiField("category")
	...
	public static class OpenTrainOrderRs extends TaobaoObject {
		private static final long serialVersionUID = 7631129378139224153L;
		/**
		 * 商旅审批单id
		 */
		@ApiField("apply_id")
