...
public interface CorpStaffDao {
     ...
     * @return
     */
    void deleteCorpStaffByCorpIdAndUserId(@Param("corpId") String corpId, @Param("userId") String userId);
     ...
     * @return
     */
    List<CorpStaffDO> getCorpStaffListByCorpId(@Param("corpId") String corpId);
     ...
     * @return
     */
    List<CorpStaffDO> getCorpStaffListByCorpIdAndIsAdmin(@Param("corpId") String corpId, @Param("isAdmin") Boolean isAdmin);
     ...
     * @return
     */
    List<String> getCorpStaffUserIdListByCorpId(@Param("corpId") String corpId);
