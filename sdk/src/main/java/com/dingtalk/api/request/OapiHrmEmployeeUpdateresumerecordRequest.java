...
import com.dingtalk.api.response.OapiHrmEmployeeUpdateresumerecordResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.hrm.employee.updateresumerecord request
 * 
 * @author top auto create
 * @since 1.0, 2018.07.25
 */
public class OapiHrmEmployeeUpdateresumerecordRequest extends BaseTaobaoRequest<OapiHrmEmployeeUpdateresumerecordResponse> {
	...
	* webOA后台url
	...
	public Class<OapiHrmEmployeeUpdateresumerecordResponse> getResponseClass() {
		return OapiHrmEmployeeUpdateresumerecordResponse.class;
	}
