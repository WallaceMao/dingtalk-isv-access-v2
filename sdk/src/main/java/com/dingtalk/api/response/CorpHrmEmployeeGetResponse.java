...
public class CorpHrmEmployeeGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3116655828535693838L;
	...
	public static class SysCustomFieldVpo extends TaobaoObject {
		private static final long serialVersionUID = 5653928985136999572L;
		/**
		 * 确认入职是否必填
		 */
	...
	public static class FieldGroupVpo extends TaobaoObject {
		private static final long serialVersionUID = 2533896979374624768L;
		/**
		 * 字段列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 3844472233457766264L;
		/**
		 * dingOpenErrcode
		 */
