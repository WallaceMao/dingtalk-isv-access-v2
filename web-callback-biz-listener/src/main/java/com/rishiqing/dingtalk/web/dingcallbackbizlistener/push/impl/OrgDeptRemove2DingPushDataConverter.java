 ...
 */
public class OrgDeptRemove2DingPushDataConverter implements Callback2DingPushDataConverter {
    @Autowired
    ...
    public List<OpenSyncBizDataDO> convert(CorpCallbackQueueDO callbackDO) {
        return callbackBizDataService.convertDeptCallback(callbackDO, OpenSyncBizSyncAction.Tag.ORG_DEPT_REMOVE);
    }
}
