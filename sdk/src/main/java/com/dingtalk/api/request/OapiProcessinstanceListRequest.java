...
/**
 * TOP DingTalk-API: dingtalk.oapi.processinstance.list request
 * 
 * @author top auto create
 * @since 1.0, 2018.07.25
 */
public class OapiProcessinstanceListRequest extends BaseTaobaoRequest<OapiProcessinstanceListResponse> {
	...
	* 发起人用户id列表
	...
	public Class<OapiProcessinstanceListResponse> getResponseClass() {
		return OapiProcessinstanceListResponse.class;
	}
