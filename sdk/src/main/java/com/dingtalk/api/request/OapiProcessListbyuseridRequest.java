...
/**
 * TOP DingTalk-API: dingtalk.oapi.process.listbyuserid request
 * 
 * @author top auto create
 * @since 1.0, 2018.07.25
 */
public class OapiProcessListbyuseridRequest extends BaseTaobaoRequest<OapiProcessListbyuseridResponse> {
	...
	* 用户id, 不传表示查询企业下所有审批模板
	...
	public Class<OapiProcessListbyuseridResponse> getResponseClass() {
		return OapiProcessListbyuseridResponse.class;
	}
