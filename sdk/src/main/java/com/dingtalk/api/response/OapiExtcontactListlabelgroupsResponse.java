...
public class OapiExtcontactListlabelgroupsResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5713467124828835884L;
	...
	public static class OpenLabel extends TaobaoObject {
		private static final long serialVersionUID = 7539525182416384613L;
		/**
		 * 标签id
		 */
		@ApiField("id")
	...
	public static class OpenLabelGroup extends TaobaoObject {
		private static final long serialVersionUID = 6478434535599121444L;
		/**
		 * 标签组颜色
		 */
		@ApiField("color")
