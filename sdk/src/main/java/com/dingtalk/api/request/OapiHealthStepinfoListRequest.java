...
import com.dingtalk.api.response.OapiHealthStepinfoListResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.health.stepinfo.list request
 * 
 * @author top auto create
 * @since 1.0, 2018.07.25
 */
public class OapiHealthStepinfoListRequest extends BaseTaobaoRequest<OapiHealthStepinfoListResponse> {
	...
	* 0表示取用户步数，1表示取部门步数
	...
	public Class<OapiHealthStepinfoListResponse> getResponseClass() {
		return OapiHealthStepinfoListResponse.class;
	}
