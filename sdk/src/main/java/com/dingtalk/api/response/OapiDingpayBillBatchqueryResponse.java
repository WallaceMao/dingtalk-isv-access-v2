...
public class OapiDingpayBillBatchqueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8295699655929331499L;
	...
	public static class DingPayBillOpenBo extends TaobaoObject {
		private static final long serialVersionUID = 4434335648954595166L;
		/**
		 * 金额（单位：分）
		 */
		@ApiField("amount")
	...
	public static class BillBatchQueryOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 6242279925635798526L;
		/**
		 * billList
		 */
