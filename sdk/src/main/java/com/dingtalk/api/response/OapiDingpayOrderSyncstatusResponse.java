...
public class OapiDingpayOrderSyncstatusResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4861786657197371295L;
	...
	public static class Orders extends TaobaoObject {
		private static final long serialVersionUID = 3343366359832168735L;
		/**
		 * 金额（单位：分）
		 */
		@ApiField("amount")
	...
	public static class OrderSyncStatusOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 3615242633891317379L;
		/**
		 * orders
		 */
		@ApiListField("orders")
