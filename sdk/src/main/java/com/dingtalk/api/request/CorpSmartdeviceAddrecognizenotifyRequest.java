 ...
 */
public class CorpSmartdeviceAddrecognizenotifyRequest extends BaseTaobaoRequest<CorpSmartdeviceAddrecognizenotifyResponse> {
	...
	* 通知数据
	...
	public static class RecognizeNotifyVO extends TaobaoObject {
		private static final long serialVersionUID = 4637238987868668427L;
		/**
		 * 预约开始时间 timestamp(毫秒)
		 */
