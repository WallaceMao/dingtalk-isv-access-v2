...
/**
 * TOP DingTalk-API: dingtalk.oapi.user.listbypage request
 * 
 * @author top auto create
 * @since 1.0, 2018.09.26
 */
public class OapiUserListbypageRequest extends BaseTaobaoRequest<OapiUserListbypageResponse> {
	...
	* 支持分页查询，与offset参数同时设置时才生效，此参数代表分页大小，最大100
	...
	public Class<OapiUserListbypageResponse> getResponseClass() {
		return OapiUserListbypageResponse.class;
	}
