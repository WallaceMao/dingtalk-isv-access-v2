...
public class OapiAttendanceGetleavetimebynamesResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7877863261766793922L;
	...
	public static class ColumnForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 8693554743556259987L;
		/**
		 * 别名
		 */
		@ApiField("alias")
	...
	public static class ColumnDayAndVal extends TaobaoObject {
		private static final long serialVersionUID = 6487774784978549388L;
		/**
		 * 时间
		 */
		@ApiField("date")
	...
	public static class ColumnValForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6682728699774815454L;
		/**
		 * 列值数据
		 */
	...
	public static class ColumnValListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 1756725973381696428L;
		/**
		 * 列信息与列值数据
		 */
