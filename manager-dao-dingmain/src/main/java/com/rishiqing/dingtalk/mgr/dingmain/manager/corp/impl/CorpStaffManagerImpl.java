...
import com.rishiqing.dingtalk.mgr.dingmain.converter.corp.CorpStaffConverter;
import com.rishiqing.dingtalk.mgr.dingmain.dao.mapper.corp.CorpStaffDao;
 ...
 */
public class CorpStaffManagerImpl implements CorpStaffManager {
    @Autowired
    ...
    public List<CorpStaffVO> listCorpStaffByCorpIdAndDepartment(String corpId, Long deptId) {
        ...
        for (CorpStaffDO corpStaffDO : doList) {
            ...
            if (StringUtil.ArrayStringContainsElement(departmentString, String.valueOf(deptId))) {
