...
public class CorpMessageCorpconversationGetsendprogressResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8239387186278386465L;
	...
	public static class AsyncSendProgress extends TaobaoObject {
		private static final long serialVersionUID = 5164674962998437583L;
		/**
		 * 取值 0-100，表示处理的百分比
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 5523895738491445242L;
		/**
		 * dingOpenErrcode
		 */
