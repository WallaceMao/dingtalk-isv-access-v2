...
public class SmartworkAttendsGetleaveapprovedurationResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3648424159924186884L;
	...
	public static class ApproveDurationForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2274911374257871439L;
		/**
		 * 请假时长（单位分钟）
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 3187258417935126812L;
		/**
		 * dingOpenErrcode
		 */
