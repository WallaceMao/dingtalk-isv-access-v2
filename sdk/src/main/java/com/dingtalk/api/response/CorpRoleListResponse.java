...
public class CorpRoleListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1578179264917468237L;
	...
	public static class Roles extends TaobaoObject {
		private static final long serialVersionUID = 8871542325521171685L;
		/**
		 * 角色ID
		 */
		@ApiField("id")
	...
	public static class RoleGroups extends TaobaoObject {
		private static final long serialVersionUID = 5678445263473635149L;
		/**
		 * 角色分组名称
		 */
		@ApiField("group_name")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 4515736251725117423L;
		/**
		 * 分页是否还有数据
		 */
		@ApiField("has_more")
