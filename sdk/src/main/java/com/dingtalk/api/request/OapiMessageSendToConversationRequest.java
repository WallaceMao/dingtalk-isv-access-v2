...
public class OapiMessageSendToConversationRequest extends BaseTaobaoRequest<OapiMessageSendToConversationResponse> {
	...
	* voice消息
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 4691785515926966131L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class Form extends TaobaoObject {
		private static final long serialVersionUID = 6519679954596374213L;
		/**
		 * 1
		 */
		@ApiField("key")
	...
	public static class Rich extends TaobaoObject {
		private static final long serialVersionUID = 1888924525412792692L;
		/**
		 * 1
		 */
		@ApiField("num")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 7584736664515578287L;
		/**
		 * 1
		 */
		@ApiField("author")
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 5563495169944313563L;
		/**
		 * 1
		 */
		@ApiField("bgcolor")
	...
	public static class Oa extends TaobaoObject {
		private static final long serialVersionUID = 8122915367987155668L;
		/**
		 * 1
		 */
		@ApiField("body")
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 4421467793986451685L;
		/**
		 * 语音时长
		 */
		@ApiField("duration")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 1557947752559563189L;
		/**
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 1761814343382623687L;
		/**
		 * 消息点击链接地址
		 */
		@ApiField("messageUrl")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 5464963914338947458L;
		/**
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 1746512746724969159L;
		/**
		 * 消息内容
		 */
		@ApiField("content")
	...
	public static class BtnJson extends TaobaoObject {
		private static final long serialVersionUID = 5892299782932997747L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 7817946674811425466L;
		/**
		 * 使用独立跳转ActionCard样式时的按钮列表；必须与btn_orientation同时设置
		 */
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 2562645425195497412L;
		/**
		 * 消息内容，支持markdown，语法参考标准markdown语法。图片举例：![alt text](mediaId)
		 */
