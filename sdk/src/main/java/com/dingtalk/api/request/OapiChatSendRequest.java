...
public class OapiChatSendRequest extends BaseTaobaoRequest<OapiChatSendResponse> {
	...
	* 语音消息
	...
	public static class BtnJson extends TaobaoObject {
		private static final long serialVersionUID = 7311976362923549752L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 3712574212682741897L;
		/**
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 7149642512128558124L;
		/**
		 * 消息头部背景颜色
		 */
		@ApiField("bgcolor")
	...
	public static class Rich extends TaobaoObject {
		private static final long serialVersionUID = 3289462576824247597L;
		/**
		 * 单行富文本信息的单位
		 */
		@ApiField("num")
	...
	public static class Form extends TaobaoObject {
		private static final long serialVersionUID = 8818937156314619976L;
		/**
		 * 消息体的关键字
		 */
		@ApiField("key")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 2548548635249358425L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class Oa extends TaobaoObject {
		private static final long serialVersionUID = 7199145343622614423L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 7199735272623335587L;
		/**
		 * 语音mediaId
		 */
		@ApiField("media_id")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 1546798762495553492L;
		/**
		 * 文件mediaId
		 */
		@ApiField("media_id")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 1196128589435634564L;
		/**
		 * 图片mediaId
		 */
		@ApiField("media_id")
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 6625259372694944128L;
		/**
		 * messageUrl
		 */
		@ApiField("messageUrl")
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 3581461161697425381L;
		/**
		 * 文本消息内容
		 */
		@ApiField("content")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 5593133999288165937L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class BtnJsonList extends TaobaoObject {
		private static final long serialVersionUID = 2195129878487974114L;
		/**
		 * action_url
		 */
		@ApiField("action_url")
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 5412287393549334328L;
		/**
		 * action_card
		 */
